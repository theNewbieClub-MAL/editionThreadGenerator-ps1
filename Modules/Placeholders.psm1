...
# 	$StaffQuery = $FileName -match '^[\w\-_.]{1,16}'
# 	[regex]::Match($StaffQuery, "^[\w\-_]+").Groups[0].Value
#     <#
#         .SYNOPSIS
...
#         Alphanumeric case-sensitive with dash and underscore up to 16 characters ("[\w\-_]{,16}")
